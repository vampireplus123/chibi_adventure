...
public class GameManager : MonoBehaviour
{
    ...
    public adsWithoutReward adsWithoutReward { get; private set; }
    ...
    public void ShowFloatingText(string text, Vector2 position, Color color)
    {
        GameObject floatingText = Instantiate(FloatingText) as GameObject;
        var _position = Camera.main.WorldToScreenPoint(position);
    ...
    public void StartGame()
    {
        ...
        if (adsWithoutReward.Instance != null)
            adsWithoutReward.Instance.HideAds();
    }
    ...
    public void GameFinish()
    {
        ...
        if (adsWithoutReward.Instance != null)
            adsWithoutReward.Instance.ShowInterstitial();
    }
